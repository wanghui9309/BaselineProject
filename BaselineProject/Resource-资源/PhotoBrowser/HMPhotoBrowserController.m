...
@property (nonatomic) HMPhotoBrowserPhotos *photos;
@property (nonatomic) BOOL statusBarHidden;

@property (nonatomic) HMPhotoViewerController *currentViewer;
@property (nonatomic) UIButton *pageCountButton;
...
- (instancetype)initWithSelectedIndex:(NSInteger)selectedIndex urls:(NSArray<NSString *> *)urls {
...
- (void)prepareUI {
    ...
    center.y = self.view.frame.size.height - 40;
